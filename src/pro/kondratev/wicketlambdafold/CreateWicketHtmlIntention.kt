...
/**
 * Create HTML file for Wicket Panel or Page
 */
class CreateWicketHtmlIntention : BaseElementAtCaretIntentionAction() {
    ...
    override fun isAvailable(project: Project, editor: Editor?, element: PsiElement): Boolean {
        ...
        return (
            ...
            psiClass.containingFile.containingDirectory.findFile(psiClass.name.plus(".html")) == null
        )
    }
    ...
    override fun getFamilyName(): String {
        return WicketLambdaFoldBundle.defaultableMessage("intention.category.wicket.html")
    }
